            ...
            <tbody>
                @foreach ($movimientos as $movimiento)
                    <tr
                        ...
                        <td class="px-2 py-1.5">
                            {{ $movimiento->transporteCliente->name }} {{ $movimiento->transporteCliente->lastname }}
                        </td>
                        <td class="px-2 py-1.5">
                        ...
                        <td class="px-2 py-1.5">
                            <div class="flex gap-3">
                                ...
                                <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512"
                                    ...
                                    wire:click="$dispatch('openModal', {component: 'devolucion.editar', arguments: {id: {{ $movimiento->id }}}})">
                                    <path
