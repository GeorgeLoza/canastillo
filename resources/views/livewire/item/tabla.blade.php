                        ...
                        <td class="px-2 py-1.5">
                            <div class=" flex gap-2">
                                <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512"
                                    class="w-4 h-4 fill-green-600" wire:click="$dispatch('openModal', {component: 'item.editar', arguments: {id: {{ $item->id }}}})">
                                    <path
                                ...
                                <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 448 512"
                                    class="w-4 h-4 fill-red-600" wire:click="delete({{ $item->id }})"
                                    wire:confirm="Esta seguro que desea borrar el item?">
                                    <path
